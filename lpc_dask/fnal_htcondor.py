...
from dask_jobqueue.core import JobQueueCluster, Job, job_parameters, cluster_parameters
...
""".lstrip()
    ...
    submit_command = "original_condor_submit -name lpcschedd3.fnal.gov"
    cancel_command = "/usr/libexec/condor/condor_rm -name lpcschedd3.fnal.gov"
    fnal_schedd = "lpcschedd3.fnal.gov"
    ...
    executable = os.path.abspath(os.path.join(os.path.dirname(__file__),"../bin/dask_worker.sh"))
